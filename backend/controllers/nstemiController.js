...
async function updateNstemiRecord(req, res) {
  ...
  try {
    ...
    reqOutcomes.input('major_bleeding', sql.NVarChar(3), strVal('major_bleeding'));
    reqOutcomes.input('outcome_other', sql.VarChar(255), val('outcome_other'));
    reqOutcomes.input('beta_blocker', sql.NVarChar(3), strVal('discharge_beta_blocker') || strVal('beta_blocker'));
    reqOutcomes.input('calcium_channel_blocker', sql.NVarChar(3), strVal('discharge_calcium_channel_blocker') || strVal('calcium_channel_blocker'));
    reqOutcomes.input('nitrate', sql.NVarChar(3), strVal('discharge_nitrate') || strVal('nitrate'));
    reqOutcomes.input('nicorandil', sql.NVarChar(3), strVal('discharge_nicorandil') || strVal('nicorandil'));
    reqOutcomes.input('ivabradine', sql.NVarChar(3), strVal('discharge_ivabradine') || strVal('ivabradine'));
    reqOutcomes.input('ranolazine', sql.NVarChar(3), strVal('discharge_ranolazine') || strVal('ranolazine'));
    reqOutcomes.input('trimetazidine', sql.NVarChar(3), strVal('discharge_trimetazidine') || strVal('trimetazidine'));
    reqOutcomes.input('aspirin', sql.NVarChar(3), strVal('discharge_aspirin') || strVal('aspirin'));
    reqOutcomes.input('clopidogrel', sql.NVarChar(3), strVal('discharge_clopidogrel') || strVal('clopidogrel'));
    reqOutcomes.input('prasugrel', sql.NVarChar(3), strVal('discharge_prasugrel') || strVal('prasugrel'));
    reqOutcomes.input('ticagrelor', sql.NVarChar(3), strVal('discharge_ticagrelor') || strVal('ticagrelor'));
    reqOutcomes.input('statin', sql.NVarChar(3), strVal('discharge_statin') || strVal('statin'));
    reqOutcomes.input('statin_10mg', sql.NVarChar(3), strVal('discharge_statin_10mg') || strVal('statin_10mg'));
    reqOutcomes.input('statin_20mg', sql.NVarChar(3), strVal('discharge_statin_20mg') || strVal('statin_20mg'));
    reqOutcomes.input('statin_40mg', sql.NVarChar(3), strVal('discharge_statin_40mg') || strVal('statin_40mg'));
    reqOutcomes.input('statin_80mg', sql.NVarChar(3), strVal('discharge_statin_80mg') || strVal('statin_80mg'));
    reqOutcomes.input('discharge_other_medication', sql.VarChar(255), val('discharge_other_medication'));
    await reqOutcomes.query(`
