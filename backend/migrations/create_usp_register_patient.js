...
async function createRegisterPatientSP() {
  const pool = await db.getPool();
  console.log('Creating / Updating stored procedure dbo.usp_RegisterPatient...');
  ...
  console.log('✓ Stored procedure dbo.usp_RegisterPatient created successfully.');
}

if (require.main === module) {
  createRegisterPatientSP().then(() => process.exit(0)).catch(e => { console.error(e); process.exit(1); });
}

module.exports = { createRegisterPatientSP };
